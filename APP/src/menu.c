...
void menu_init()
{
	...
	GUI_DispStringHCenterAt("����ϵͳ�ۺ����", (GUI_GetXSize() + 0) / 2, 16);
	GUI_DispStringHCenterAt("���� 16041531", (GUI_GetXSize() + 0) / 2, 32);
	GUI_DispStringHCenterAt("Advisor: ��ع", (GUI_GetXSize() + 0) / 2, 48);
	GUI_Update();
	Led_Startup_1();
	GUI_Clear();
...
void menu_constructor_main_static()
{
	...
	GUI_DispStringAt("����ϵͳ�ۺϿγ����", 2, 2);
	
	if(menu.page_index < 3) {
		GUI_DispStringAt("��", 10, 20 + menu.page_index * 14);
		GUI_DispStringAt("1.ϵͳ����", 25, 20);
		GUI_DispStringAt("2.��̬����", 25, 34);
		GUI_DispStringAt("3.���ݴ���", 25, 48);
		GUI_DispStringAt("1/2", 106, 50);
	}
	else if(menu.page_index < 5) {
		GUI_DispStringAt("��", 10, 20 + (menu.page_index - 3) * 14);
		GUI_DispStringAt("4.˫��ͨ��", 25, 20);
		GUI_DispStringAt("5.Զ�̿���", 25, 34);
...
static void menu_constructor_functions_1_static()
{
	...
	GUI_DispStringAt("ϵͳ����", 2, 2);
	GUI_DispStringAt("1/4", 108, 2);
	
	GUI_DispStringAt("LED״̬:", 8, 21);
	GUI_DispStringAt("����״̬:", 8, 39);
}
...
static void menu_constructor_functions_2_static()
{
	...
	GUI_DispStringAt("AD����", 8, 21);
	GUI_DispStringAt("��ѹ����:", 72, 21);
}
...
static void menu_constructor_transfer_1_static()
{
	...
	GUI_DispStringAt("���ݴ���", 2, 2);
	GUI_DispStringAt("1/2", 108, 2);
	
	GUI_DispStringAt("֡��ʽ:", 8, 20);
	GUI_DispStringAt("���ͼ��:", 8, 34);
	GUI_DispStringAt("���ͼ���:", 8, 48);
}
...
static void menu_constructor_transfer_2_static()
{
	...
	GUI_DispStringAt("���ռ���:", 8, 20);
	GUI_DispStringAt("ָ������:", 8, 34);
	GUI_DispStringAt("ָ����Դ:", 8, 48);
}
...
static void menu_constructor_dual_static()
{
	...
	GUI_DispStringAt("˫��ͨ��", 2, 2);
	GUI_DispStringAt("1/1", 108, 2);
	
	GUI_DispStringAt("1.ģʽ�л�:", 19, 20);
	GUI_DispStringAt("2.ƥ���豸:", 19, 34);
	GUI_DispStringAt("3.���ִ���:", 19, 48);
}
...
static void menu_constructor_remote_1_static()
{
	...
	GUI_DispStringAt("Զ�̿���", 2, 2);
	GUI_DispStringAt("1/2", 108, 2);
	
	GUI_DispStringAt("Զ�̿���:", 8, 20);
	GUI_DispStringAt("����ʱ��:", 8, 34);
}
...
static void menu_constructor_transfer_1_dynamic()
{
	...
	switch(app.present_upload_frame) {
		case 0 :
			sprintf(disp_buffer, "7MBD+����+\\n");
		break;
		
		case 1 :
			sprintf(disp_buffer, "7MY+����+\\n");
		break;
		
		case 2 :
			sprintf(disp_buffer, "7MR+����+\\n");
		break;
